...
function pccf_render_form() {
	...
	<div class="wrap">
		...
		<div class="notice" style="border: 2px #DAA520 solid;margin: 20px 0;">
			...
			<div style="display:flex;">
				...
				<div style="margin-left: 15px;">
					<p><b>New feature in <a href="https://wpgoplugins.com/plugins/content-censor/" target="_blank">Content Censor 0.4</a> <small>(13th March, 2017)</small> ignores censored keywords in HTML tags and attributes!</b></p>
					<p>Occasionally you might have a keyword that is used as the source URL for an image or as part of a HTML link. Normally this will be censored too, breaking the link. But in <a href="https://wpgoplugins.com/plugins/content-censor/" target="_blank">Content Censor 0.4</a> you can now optionally choose to ignore HTML tags and all their attributes.</p>
				</div>
			</div>
		</div>
		...
		if( strtotime($discount_date) > strtotime('now') ) {
			...
			echo '<p style="background: #eee;border: 1px dashed #ccc;font-size: 13px;margin: 0 0 10px 0;padding: 5px 0 5px 8px;">As a user of our free plugins here\'s a bonus just for you! <strong>Get 30% OFF</strong> the price of our brand new WordPress theme <a href="http://wpgothemes.com/themes/flexr/" target="_blank"><strong>Flexr WordPress theme</strong></a>. <b>Plus, every theme comes with optional FREE web hosting for 12 months!</b> Simply enter the following code at checkout: <code>WPGO30OFF</code></p>';
		}
		...
		<div style="clear:both;">
			<p>
				...
				<input class="button" style="vertical-align:12px;" type="button" value="Flexr, Our Latest Theme" onClick="window.open('http://wpgothemes.com/flexr/')">
			</p>
		</div>
